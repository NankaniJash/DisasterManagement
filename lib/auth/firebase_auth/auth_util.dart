...
DocumentReference? get currentUserReference =>
    loggedIn ? UserPostsRecord.collection.doc(currentUser!.uid) : null;

UserPostsRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : UserPostsRecord.getDocument(UserPostsRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
